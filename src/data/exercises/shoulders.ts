...
export const SHOULDER_EXERCISES: Exercise[] = [
  ...
  },
  {
    ...
    nameJa: "アーノルドプレス",
    nameEn: "Arnold Press",
    youtubeUrl: "https://www.youtube.com/results?search_query=アーノルドプレス+フォーム",
    targetMuscles: ["三角筋前部", "三角筋中部", "上腕三頭筋"],
    muscles: ["front-delt", "side-delt", "triceps"],
    equipment: "dumbbell",
    isCustom: false,
    howTo: [
      "ダンベルを顔の前で、手のひらを自分に向けて構える",
      "手首を外へ回しながら頭上へ押し上げる",
      "頂点で手のひらが前を向くようにする",
      "回しながら元の位置へゆっくり戻す",
    ],
  ...
  },
  {
    ...
    nameJa: "フロントレイズ",
    nameEn: "Front Raise",
    youtubeUrl: "https://www.youtube.com/results?search_query=フロントレイズ+フォーム",
    targetMuscles: ["三角筋前部"],
    muscles: ["front-delt"],
    equipment: "dumbbell",
    isCustom: false,
    howTo: [
      "ダンベルを太ももの前で持ち、まっすぐ立つ",
      "肘を軽く曲げたまま、腕を前方へ持ち上げる",
      "肩の高さまで上げたら止める",
      "ゆっくり下ろして負荷を抜かない",
    ],
    cautions: [
  ...
  },
  {
    ...
    nameJa: "アップライトロウ",
    nameEn: "Upright Row",
    youtubeUrl: "https://www.youtube.com/results?search_query=アップライトロウ+フォーム",
    targetMuscles: ["三角筋中部", "僧帽筋"],
    muscles: ["side-delt", "traps"],
    equipment: "barbell",
    isCustom: false,
    howTo: [
      "バーを肩幅程度で持ち、太ももの前で構える",
      "肘を先行させてバーを鎖骨あたりまで引き上げる",
      "肘が肩の高さに来たら止める",
      "ゆっくり下ろして戻す",
    ],
    cautions: [
      "手幅が狭すぎると肩を痛めやすい（肩幅程度に）",
      "肘を肩より高く上げすぎない",
      "反動で引き上げない",
    ],
    beginnerTips: [
  ...
  },
  {
    ...
    nameJa: "フェイスプル",
    nameEn: "Face Pull",
    youtubeUrl: "https://www.youtube.com/results?search_query=フェイスプル+フォーム",
    targetMuscles: ["三角筋後部", "僧帽筋"],
    muscles: ["rear-delt", "traps"],
    equipment: "cable",
    isCustom: false,
    howTo: [
      "ケーブルを顔の高さにセットし、ロープを握る",
      "やや後ろに下がって腕を伸ばし構える",
      "肘を高く保ちながら顔に向かって引く",
      "両手を耳の横まで引いたらゆっくり戻す",
    ],
